...
class PostOrderDFSTest {
    ...
    @Nested
    class PostOrderByTwoStacks {

        @Test
        void shouldReturnEmptyListForTreeWithNoNodes() {
            var output = PostOrderDFS.postOrderByTwoStacks(null);
        ...
        void shouldReturnFirstNodeValueGivenTreeWithOneNode() {
            ...
            var output = PostOrderDFS.postOrderByTwoStacks(root);
        ...
        void shouldReturnNodesInDfsOrderForBalancedBinaryTree() {
            ...
            var output = PostOrderDFS.postOrderByTwoStacks(a);
        ...
        void shouldReturnNodesInDfsOrderForUnbalancedBinaryTree() {
            ...
            var output = PostOrderDFS.postOrderByTwoStacks(one);
    ...
    @Nested
    class PostOrderByOneStack {

        @Test
        void shouldReturnEmptyListForTreeWithNoNodes() {
            var output = PostOrderDFS.postOrderByOneStack(null);
        ...
        void shouldReturnFirstNodeValueGivenTreeWithOneNode() {
            ...
            var output = PostOrderDFS.postOrderByOneStack(root);
        ...
        void shouldReturnNodesInDfsOrderForBalancedBinaryTree() {
            ...
            var output = PostOrderDFS.postOrderByOneStack(a);
        ...
        void shouldReturnNodesInDfsOrderForUnbalancedBinaryTree() {
            ...
            var output = PostOrderDFS.postOrderByOneStack(one);
