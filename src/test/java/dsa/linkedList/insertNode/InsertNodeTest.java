...
class InsertNodeTest {
    ...
    @Nested
    class InsertNodeRecursiveSimplified {
        ...
        void shouldInsertAtBeginningOfLinkedList() {
            ...
            var output = InsertNode.insertNodeRecursiveSimplified(a, "z", 0);
        ...
        void shouldInsertAtTheEndOfLinkedList() {
            ...
            var output = InsertNode.insertNodeRecursiveSimplified(a, "m", 4);
        ...
        void shouldInsertAtTheMiddleOfLinkedList() {
            ...
            var output = InsertNode.insertNodeRecursiveSimplified(a, "v", 3);
        ...
        void shouldInsertNodeAtGivenPositionInLinkedList() {
            ...
            var output = InsertNode.insertNodeRecursiveSimplified(a, "x", 2);
