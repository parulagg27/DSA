...
class ZipperListsTest {
    ...
    @Nested
    class ZipperListsByShiftingCurrentAndNextPointer {
        ...
        void shouldZipperListsOfEqualSize() {
            ...
            var output = ZipperLists.zipperListsByShiftingCurrentAndNextPointer(a, x);
        ...
        void shouldZipperListsWithList2BiggerThanList1() {
            ...
            var output = ZipperLists.zipperListsByShiftingCurrentAndNextPointer(s, one);
        ...
        void shouldZipperListsWithList1OfSize1() {
            ...
            var output = ZipperLists.zipperListsByShiftingCurrentAndNextPointer(w, one);
        ...
        void shouldZipperListsWithList2OfSize1() {
            ...
            var output = ZipperLists.zipperListsByShiftingCurrentAndNextPointer(one, w);
    ...
    @Nested
    class ZipperByOddEvenAndCurrentPointer {
