...
class RemoveMiddleNodeTest {
    ...
    @Nested
    class DeleteMiddleBySlowFastPointer {

        @Test
        void shouldReturnNullIfNoNodesInLinkedList() {
            var output = RemoveMiddleNode.deleteMiddleBySlowFastPointer(null);
        ...
        void shouldReturnNullIfOnly1NodeInList(){
            ...
            var output = RemoveMiddleNode.deleteMiddleBySlowFastPointer(input);
        ...
        void shouldRemoveLastNodeIf2NodesInList(){
            ...
            var output = RemoveMiddleNode.deleteMiddleBySlowFastPointer(listHead);
